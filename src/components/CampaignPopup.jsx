...
const CampaignPopup = () => {
    ...
    useEffect(() => {
        if (location.pathname.includes("/administrative")) {
            setIsVisible(false);
            return;
        }
    ...
    if (!topCampaign || !isVisible) return null;
        ...
        <div className="promo-popup">
            <div className="popup-content">
                ...
                <div className="promo-text">
                    ...
                    <Link
                        to={`/campaigns/${slugify(topCampaign.title, { lower: true })}`}
                        onClick={() => setIsVisible(false)}
                        className="details-btn"
                    >
                        Daha ətraflı <IoIosArrowForward />
                    </Link>
                </div>
            </div>
        </div>
